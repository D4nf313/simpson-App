  ...
  template: `
    <div class="form-container cartoon-card">
      <div class="flex justify-content-between align-items-center mb-4">
        <h2 class="cartoon-text m-0">
          {{ isEditMode() ? 'Editar Personaje' : 'Crear Personaje' }}
        </h2>
        <button routerLink="/characters" class="cartoon-btn secondary">
          Volver
        </button>
      </div>
        ...
        <div class="formgrid grid">
          ...
          <div class="field col-12 md:col-6">
            ...
            <input
              ...
              class="cartoon-input w-full"
              placeholder="Ej: El Barón de la Cerveza"
            />
          </div>
          ...
          <div class="field col-12 md:col-6">
            ...
            <input
              ...
              class="cartoon-input w-full"
              placeholder="Ej: Inspector de Seguridad"
            />
          </div>
...
export class CharacterFormComponent implements OnInit {
  ...
  onImageUrlChange() {
    const url = this.characterForm.get('imageUrl')?.value;
  ...
  onSubmit() {
    ...
    if (this.isEditMode() && this.characterId()) {
      this.characterService
        .updateCharacter(this.characterId()!, characterData)
        .subscribe(() => {
